                                ...
                                .then(async (message) => {
                                    if (message) {
                                        ...
                                        if (time) {
                                            ...
                                            const embed = await client.giveawayManager.generateGiveaway(client, data, message.guild.me.displayHexColor, message.id)
                                            await message.edit(":tada: **GIVEAWAY** :tada:", embed);
                                        }
                                    }
                                }).catch(err => { return; });
                        } catch (error) { return; };
